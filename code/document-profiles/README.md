...
|    | |
|----|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![Info](/docs/images/information_mark.png)    | In order to account for only those MeSH terms that are present in the corpus and to avoid a document frequency of zero, we extract only the relevant MeSH terms before creating our matrices.                                                                                                                                                                                              |
|  ![Info](/docs/images/exclamation_mark.png)   | This implies that the number of columns in both the TF and TF-IDF matrices would only be a subset of the total MeSH vocabulary.                                                               |
