...
You can find the code corresponding to the creation of a dictionary for the [Medical Subject Headings vocabulary](https://www.nlm.nih.gov/mesh/meshhome.html) at ToDo. Please be aware that due to license restrictions, we can only provide the code but not the actual data for the corresponding dictionary.
